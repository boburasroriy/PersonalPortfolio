...
<head>
    ...
    <title> <?php echo e(__('My Portfolio')); ?></title>
    <style>
        body {
...
<?php if(Route::has('login')): ?>
    <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
        <?php if(auth()->guard()->check()): ?>
            <a href="<?php echo e(route('profile', auth()->user()->id)); ?>" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"><?php echo e(auth()->user()->first_name); ?></a>
        <?php else: ?>
...
<?php /**PATH C:\Users\Asus\Desktop\Personal Website\Personal\resources\views/home/home.blade.php ENDPATH**/ ?>