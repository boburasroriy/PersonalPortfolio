...
<?php endif; ?>
        ...
        <div class="post-content">
            ...
            <!-- Post information -->
            <div class="post-info">
                <p style="color: purple"> Post created: <?php echo e($post->created_at->format('M d, Y')); ?> </p>
                <p style="color: #C0C5D0; margin-top: -10px ; font-size: 15px">  category: <?php echo e($post->category->name); ?></p>
            ...
            <div class="comments-section">
                <?php $__currentLoopData = $post->comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="comment">
                        <p><strong><?php echo e($comment->user->first_name . ' ' . $comment->user->last_name); ?></strong> commented at <?php echo e($comment->created_at->diffForHumans()); ?></p>
